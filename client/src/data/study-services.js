...
const vendorNeutralCapabilities = [
  ...
  },
  {
    ...
    description: "Packaged model endpoint that exposes optimized inference APIs with health checks, model profiles, auth, metrics, and deployment hooks.",
    exams: ["Agentic AI General"],
    lifecycle: "Serving and deployment",
    group: "Serving and operations",
    filters: ["Agentic AI General", "Serving and deployment", "Inference optimization"],
    use: "Use when the scenario asks for production model APIs, self-hosted endpoints, deployment packaging, or operational model serving.",
    ...
    keywords: ["endpoint", "inference", "microservice", "API", "model serving"],
    studyNotes: [
      ...
      "It owns API behavior, health, deployment packaging, metrics, auth, and operational profiles.",
      "It does not by itself solve orchestration, retrieval, or guardrails unless those are explicitly built around it."
    ],
    mustKnow: ["endpoint API", "health checks", "auth", "model profiles", "rollout"],
    examSignals: ["production endpoint", "self-hosted API", "container", "serving profile"],
  ...
  },
  {
    ...
    description: "Live operations layer for traces, logs, metrics, tool-call health, retrieval quality, latency, errors, drift, incidents, and replay.",
    exams: ["Agentic AI General"],
    lifecycle: "Monitoring and profiling",
    group: "Serving and operations",
    filters: ["Agentic AI General", "Monitoring and profiling", "Evaluation", "Serving and deployment"],
    use: "Use when the scenario is about live failures, p95/p99 latency, route drift, empty tool results, trace replay, or incident diagnosis.",
    ...
    keywords: ["observability", "trace", "latency", "monitoring", "drift"],
    studyNotes: [
      ...
      "Track model, retrieval, tools, guardrails, route choice, latency, cost, and human escalation as one workflow.",
      "Good observability supports replay and turns incidents into regression tests."
    ],
    mustKnow: ["traces", "tool success", "p95/p99", "route drift", "replay"],
    examSignals: ["HTTP 200 but failed task", "incident", "cost spike", "latency gap", "empty tool result"],
  ...
  },
  {
    ...
    use: "Use when constraints mention p99 latency, throughput, token cost, context bloat, model routing, caching, quantization, or batching.",
    ...
    keywords: ["cost", "latency", "batching", "quantization", "routing", "KV cache"],
    studyNotes: [
    ...
    mustKnow: ["prefill vs decode", "context size", "KV cache", "batching", "route drift"],
    examSignals: ["p99", "tokens/sec", "cost spike", "long context", "queueing"],
...
export const studySections = [
  ...
  },
  {
    ...
    weight: 14,
    description: "Expose models as APIs with serving gateways, containers, batching, scaling, rollout, fallback, and health checks.",
    keyIdeas: ["inference microservice", "model serving gateway", "canary", "batching", "fallback"],
    use: "Study this when scenarios involve endpoints, latency, deployment packaging, scaling, or traffic management.",
  ...
  },
  {
    ...
    keyIdeas: ["tracing", "task success", "p99 latency", "cost routing", "incident replay"],
    use: "Study this when a live agent is slow, expensive, failing silently, or drifting from intended routes.",
